                    ...
                    <div className="w-full bg-white p-6 rounded-3xl shadow-sm border border-slate-100 flex flex-col items-center text-center">
                        ...
                        <form onSubmit={handleMarkAttendance} className="w-full space-y-4">
                            <input 
                                type="text" 
                                required 
                                placeholder="Simulate QR Scan (Paste string)" 
                                value={qrCodeData}
                                onChange={(e) => setQrCodeData(e.target.value)}
                                className="w-full bg-slate-50 border border-slate-200 rounded-xl py-3 px-4 text-sm focus:ring-1 focus:ring-brand-500 outline-none"
                            />
                            <input 
                                type="text" 
                                required 
